...
# sheet from this geometry and requires the five principal dimension strings and
# the material spec in the PDF's text layer. These checks are the geometry the
# sheet is a drawing OF — if the model is wrong the sheet is wrong, whatever it
# prints.
#
# - envelope: 600 wide, 250 deep, 218 tall (deck plus 200 mm of side panel);
# - material: exact volume. Deck 600 x 250 x 18 = 2700000 mm^3 less the 8 mm
...
CHECKS = {
    ...
    "shelf_material": lambda m: m.volume("shelf/part") == approx(_VOLUME_MM3, abs=50.0),
