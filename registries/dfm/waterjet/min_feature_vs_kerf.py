# waterjet.min_feature_vs_kerf — the smallest thing a jet of finite width can cut.
#
# The jet removes a kerf of material as it travels, so a bore whose diameter
# approaches the kerf has no material left to define it: it either fails to cut
# through or closes as the jet wanders. The limit is the larger of an absolute
# floor and a multiple of the kerf, because a very fine orifice still has a
# practical minimum.
#
