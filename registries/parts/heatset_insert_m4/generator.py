# M4 heat-set (thermal) insert — brass envelope with its knurl band, thread-free.
#
# Coordinate convention: the ORIGIN sits on the boss top face. The insert body
# runs 0 .. -8.2 mm in Z, i.e. straight down into the boss. Instance it at the
...
# rather than a diamond pattern, and the internal thread is a plain 4 mm bore.
...
#   boss pilot hole      5.6 mm dia, >= 9.2 mm deep (insert length + melt relief)
#   min boss wall        >= 2 mm around the pilot hole
...
_length = 8.2
_body_d = 5.6 + 2 * _clearance
_knurl_d = 6.3 + 2 * _clearance
_knurl_h = 2.0
_bore_d = 4.0
...
_insert.label = "heatset_insert_m4"
