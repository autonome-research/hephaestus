# M5 heat-set (thermal) insert — brass envelope with its knurl band, thread-free.
#
# Coordinate convention: the ORIGIN sits on the boss top face. The insert body
# runs 0 .. -9.5 mm in Z, i.e. straight down into the boss. Instance it at the
...
# rather than a diamond pattern, and the internal thread is a plain 5 mm bore.
...
#   boss pilot hole      6.4 mm dia, >= 10.5 mm deep (insert length + melt relief)
#   min boss wall        >= 2.4 mm around the pilot hole
...
_length = 9.5
_body_d = 6.4 + 2 * _clearance
_knurl_d = 7.1 + 2 * _clearance
_knurl_h = 2.4
_bore_d = 5.0
