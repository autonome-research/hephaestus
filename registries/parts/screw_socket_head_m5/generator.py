# M5 socket-head cap screw — DIN 912 head/shank envelope, thread-free.
#
# Coordinate convention: the ORIGIN sits on the head bearing face. The head
# occupies 0 .. +5 mm in Z; the shank hangs below into the workpiece. Place an
...
#   clearance hole  5.5 mm    counterbore  10 mm dia x >= 5 mm deep
