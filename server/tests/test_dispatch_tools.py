...
def _minimal_args(tool: str) -> dict[str, Any]:
    table: dict[str, dict[str, Any]] = {
        ...
        "read_proposals": {},
        # CAM.md §3 (Stage 14B) — the five declared-state quartet families
        # need the engine just as much: without CadOps there is no ledger.
        "declare_setup": {
            "id": "s-op1",
            "spindle_axis": "+Z",
            "order": 1,
        ...
        "update_setup": {"id": "s-op1", "patch": {"note": "n"}, "reason": "fixture"},
        "read_setups": {},
        "declare_stock": {
            "id": "st-plate",
            "kind": "rectangular",
        ...
        "update_stock": {"id": "st-plate", "patch": {"note": "n"}, "reason": "fixture"},
        "read_stock": {},
        "declare_fixture": {
            "id": "fx-vise",
        ...
        "update_fixture": {"id": "fx-vise", "patch": {"note": "n"}, "reason": "fixture"},
        "read_fixtures": {},
        "declare_wcs": {
            "id": "w-g54",
            "code": "G54",
        ...
        "update_wcs": {"id": "w-g54", "patch": {"note": "n"}, "reason": "fixture"},
        "read_wcs": {},
        "declare_operation": {
            "id": "op-1",
            "setup": "s-op1",
        ...
        "update_operation": {"id": "op-1", "patch": {"note": "n"}, "reason": "fixture"},
        "read_operations": {},
