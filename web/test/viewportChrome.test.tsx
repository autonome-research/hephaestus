...
// §5.5's view cube and §3.11.6's axis triad are STRUCK (2026-09-20) — both were
// persistent overlays over the model itself. Their own describes went with
// them; what survives is `FURNITURE` below, which asserts that NEITHER paints
// over an empty well, and now also that neither exists at all.
